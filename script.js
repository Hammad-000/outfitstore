...
card.innerHTML = `
  ...
  <div class="flex flex-1 flex-col p-5">
    ...
    <div class="mt-auto flex items-center justify-between pt-3 border-t border-gray-50">
      ...
      <button class=" card cursor-pointer inline-flex items-center justify-center gap-1.5 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors duration-200 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
